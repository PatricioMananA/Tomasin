...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textName.setText("Nombre profesor : " + users.getUserName());
        holder.textEmail.setText("sede : " + users.getUserEmail());
        holder.textCountry.setText("Mensaje : " + users.getUserCountry());
            ...
            buttonUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        Toast.makeText(context, "Ingresa toda la informacion...", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        public void showDialog(Context context, String id) {
            ...
            buttonDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(context, "Registro borrado correctamente!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
